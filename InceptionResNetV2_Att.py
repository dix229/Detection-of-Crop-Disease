...
"""from keras.engine.topology import get_source_input"""
...
def InceptionResNetV2_Att(include_top=False,
                      weights_path=None,
                      weights='imagenet',
                      input_tensor=None,
                      input_shape=None,
    ...
    dropout = Dropout(0.8)(x)
    outputs = Dense(classes, activation='softmax', name='predictions')(dropout)

    # Create model
    model = Model(inputs, outputs, name='inception_resnet_v2')
